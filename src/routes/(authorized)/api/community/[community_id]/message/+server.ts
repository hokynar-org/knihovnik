...
import type { BorrowRequest, CommunityMessage, Item, PublicItemSafe } from '$lib/types';
...
export const POST = (async ({params, locals, url, request}) => {
    ...
    const new_message_plus:CommunityMessage={...new_message,user_name:user.user_name};
